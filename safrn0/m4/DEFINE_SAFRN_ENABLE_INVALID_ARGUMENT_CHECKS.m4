...
dnl
AC_DEFUN([DEFINE_SAFRN_ENABLE_INVALID_ARGUMENT_CHECKS], [[{

#
# The block that contains this comment is the expansion of the
# DEFINE_SAFRN_ENABLE_INVALID_ARGUMENT_CHECKS macro.
#]dnl
m4_ifdef(
  [DEFINE_SAFRN_ENABLE_INVALID_ARGUMENT_CHECKS_HAS_BEEN_CALLED],
  [gatbps_fatal([
    DEFINE_SAFRN_ENABLE_INVALID_ARGUMENT_CHECKS has already been called
  ])],
  [m4_define([DEFINE_SAFRN_ENABLE_INVALID_ARGUMENT_CHECKS_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    DEFINE_SAFRN_ENABLE_INVALID_ARGUMENT_CHECKS requires exactly 0
    arguments
...
[
  ...
  [SAFRN_ENABLE_INVALID_ARGUMENT_CHECKS],
